...
describe('cloud', function () {
    ...
    describe('prefetch', function () {
        it('should make correct request to api', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new CloudClient(testSession).prefetch()];
                    case 1:
                        res = _a.sent();
        ...
        it('should make correct list request', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        clouds = { test: true };
                        return [4 /*yield*/, new CloudClient(testSession).list(tslib_1.__assign({}, clouds))];
                    case 1:
                        res = _a.sent();
                        expect(res).toEqual({
                            apikey: testApiKey,
        ...
        it('should cache session token to local storage', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        clouds = { token: true };
                        return [4 /*yield*/, new CloudClient(testSession, { sessionCache: true }).list(tslib_1.__assign({}, clouds))];
                    case 1:
                        res = _a.sent();
        ...
        it('should make correct list request with security', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        clouds = { test: true };
                        return [4 /*yield*/, new CloudClient(tslib_1.__assign({}, testSession, testSecurity)).list(tslib_1.__assign({}, clouds))];
                    case 1:
                        res = _a.sent();
    ...
    describe('store', function () {
        ...
        it('should make correct basic with security', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new CloudClient(tslib_1.__assign({}, testSession, testSecurity)).store('token', 'test', { filename: '1' })];
                    case 1:
                        res = _a.sent();
        ...
        it('should make correct request with security', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testUrl = 'http://test.com';
                        return [4 /*yield*/, new CloudClient(tslib_1.__assign({}, testSession, testSecurity)).metadata(testUrl)];
                    case 1:
                        res = _a.sent();
    ...
    describe('OpenTok', function () {
        describe('tokInit', function () {
            ...
            it('should throw on wrong type', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    expect(function () {
                        new CloudClient(testSession).tokInit('videoa').then(function () {
                            console.log('init');
                        }).catch(function () {
                            console.log('err');
                        });
